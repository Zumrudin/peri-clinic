...
const home = defineCollection({
  ...
  schema: z.object({
    ...
    gift_button_label: z.string().nullable().optional(),
    gift_context: z.string().nullable().optional(),
    gift_video_url: z.string().nullable().optional(),
    gift_poster_url: z.string().nullable().optional(),
    gift_video_label: z.string().nullable().optional(),
    gift_play_label: z.string().nullable().optional(),
    gift_pause_label: z.string().nullable().optional(),
...
const siteSettings = defineCollection({
  ...
  schema: z.object({
    ...
    nearest_metro: z.string().nullable().optional(),
    metro_walk_time: z.string().nullable().optional(),
    metro_directions: z.string().nullable().optional(),
